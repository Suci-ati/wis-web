        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="process-login" method="POST">
                    ...
                    @endif
                    <div class="wrap-input100 validate-input" data-validate="Masukkan NIM yang benar! BANG JAGO">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Masukkan kata sandi yang benar! BANG JAGO">
